---
title: "Introduction to urltools"
author: "Oliver Keyes"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to urltools}
...
paying attention to where those slashes *are*: if we run <code>URLencode("https://en.wikipedia.org", reserved = TRUE)
</code>, for example, we get:

```{r, eval=FALSE}
URLencode("https://en.wikipedia.org/wiki/Article", reserved = TRUE)
#[1] "https%3a%2f%2fen.wikipedia.org%2fwiki%2fArticle"
```
That's an unusable URL.
...
or API calls. Along with <code>url\_parse</code>, we also have <code>url\_param</code>, which extracts the value
