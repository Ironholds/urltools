...
One cautionary note; NAs are not fully supported. By this I don't mean that you can't pass in NA values,
but that the output won't be an NA if you do - it'll be the string "na" or "NA".
